function Get-GitResourceRepository {

    <#
    .SYNOPSIS
        Clones a git repository and reports the PowerShell module it contains, without installing it.
    .DESCRIPTION
        Clones the given repository (or repositories) to a temp directory, locates its module manifest
